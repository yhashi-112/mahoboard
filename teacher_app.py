...
DEFAULT_MODEL_CLAUDE = os.getenv('DEFAULT_MODEL_CLAUDE') or st.secrets.get('DEFAULT_MODEL_CLAUDE', 'claude-sonnet-4-6')
...
with tab4:
    ...
    if not logs:
        ...
        if stumbling_points:
            ...
            st.dataframe(sp_df.style.background_gradient(subset=['質問数'], cmap='YlOrRd'), use_container_width=True)
